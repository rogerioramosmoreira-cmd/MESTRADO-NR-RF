...
N_ITER_BUSCA = 80      # Reduzido: grupos menores convergem mais rápido
CV_FOLDS     = 5       # 5-fold: mais robusto em grupos pequenos que 10-fold
...
def grafico_comparativo_final(resultados):
    ...
    ax_tab.set_title("Resumo Comparativo — Métricas e Melhores Hiperparâmetros por Grupo",
