...
from core import dependencies, paths          # noqa: E402
...
#    O caminho vem de core.paths — antes era um caminho absoluto fixo para uma
#    pasta que deixou de existir quando o projeto foi movido.
caminho_do_arquivo_escolhido = Verificar_CSV(str(paths.RAW_DIR))
...
if caminho_do_arquivo_escolhido:
    ...
    Caminho_principal = str(paths.PROCESSED_DIR)
    Nome_base = "cbr_dataset_"
    extensao = '.csv'
