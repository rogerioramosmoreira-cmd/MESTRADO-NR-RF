...
PASTA_MODELOS = str(paths.RF_QUINTIS_DIR / CENARIO)

ARQUIVO_MODELO    = os.path.join(PASTA_MODELOS, "rf_model.joblib")
ARQUIVO_SCALER    = os.path.join(PASTA_MODELOS, "scaler.joblib")
ARQUIVO_METADADOS = os.path.join(PASTA_MODELOS, "metadata.json")
